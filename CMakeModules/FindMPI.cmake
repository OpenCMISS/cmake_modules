...
if (WIN32)
    ...
    message(STATUS "PROGRAM_FILES_PATH: ${PROGRAM_FILES_PATH} vs $ENV{ProgramFiles}")
    set(_var_with_parentheses "ProgramFiles(x86)")
    file(TO_CMAKE_PATH "$ENV{${_var_with_parentheses}}" PROGRAM_FILES_X86_PATH)
    message(STATUS "PROGRAM_FILES_X86_PATH: ${PROGRAM_FILES_X86_PATH}")
        ...
        elseif(try_libs)
            ...
            if (${lang} STREQUAL Fortran)
                ...
                if (WIN32)
                    ...
                    messagev("Looking for fortran libraries in ${_MPI_BASE_DIR} ${_MPI_PREFIX_PATH}")
                endif ()
