...
function(check_mpi_type lang)
    ...
    if (MPI_HOME)
        ...
        if (MPI_HOME_POS EQUAL -1)
            unset_mpi(${lang})
            set(MPI_${lang}_FOUND FALSE PARENT_SCOPE)
            message(SATUS "Info: The current MPI-${lang} include path '${MPI_${lang}_INCLUDE_PATH}' does not contain the given MPI_HOME '${MPI_HOME}'. Previous MPI Cache entries have been removed. Please configure again.")
            return()
        endif()
    endif()
    foreach(IDX RANGE 5)
