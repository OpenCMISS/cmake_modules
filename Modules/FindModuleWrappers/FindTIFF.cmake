...
if (NOT OC_SYSTEM_TIFF)
     set(OC_SYSTEM_TIFF NO) # set it to NO so that we have a value if none is set at all (debug output)
    ...
    if (TIFF_FOUND)
        set(TIFF_FOUND YES)
        my_stupid_package_dependent_message_function_tiff("Found version ${TIFF_FIND_VERSION} at ${TIFF_DIR} in CONFIG mode")
    endif()
else()
    ...
    if (TIFF_FOUND)
        ...
        my_stupid_package_dependent_message_function_tiff("Trying to find version ${TIFF_FIND_VERSION} on system in CONFIG mode")
...
if (TIFF_FIND_REQUIRED AND NOT TIFF_FOUND)
    message(FATAL_ERROR "OpenCMISS FindModuleWrapper error!\n"
        ...
        "Allow system TIFF: ${OC_SYSTEM_TIFF}\n"
        "Please check your OpenCMISSLocalConfig file and ensure to set USE_TIFF=YES\n"
