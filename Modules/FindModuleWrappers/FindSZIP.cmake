...
if (NOT OC_SYSTEM_SZIP)
     set(OC_SYSTEM_SZIP NO) # set it to NO so that we have a value if none is set at all (debug output)
    ...
    if (SZIP_FOUND)
        set(SZIP_FOUND YES)
        my_stupid_package_dependent_message_function_szip("Found version ${SZIP_FIND_VERSION} at ${SZIP_DIR} in CONFIG mode")
    endif()
else()
    ...
    if (SZIP_FOUND)
        ...
        my_stupid_package_dependent_message_function_szip("Trying to find version ${SZIP_FIND_VERSION} on system in CONFIG mode")
...
if (SZIP_FIND_REQUIRED AND NOT SZIP_FOUND)
    message(FATAL_ERROR "OpenCMISS FindModuleWrapper error!\n"
        ...
        "Allow system SZIP: ${OC_SYSTEM_SZIP}\n"
        "Please check your OpenCMISSLocalConfig file and ensure to set USE_SZIP=YES\n"
