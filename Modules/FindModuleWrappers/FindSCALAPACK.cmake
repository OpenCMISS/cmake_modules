...
if (NOT OC_SYSTEM_SCALAPACK)
     set(OC_SYSTEM_SCALAPACK NO) # set it to NO so that we have a value if none is set at all (debug output)
    ...
    if (SCALAPACK_FOUND)
        ...
        my_stupid_package_dependent_message_function_scalapack("Found version ${SCALAPACK_FIND_VERSION} at ${SCALAPACK_DIR} in CONFIG mode")
    endif()
else()
    ...
    if (SCALAPACK_FOUND)
        ...
        my_stupid_package_dependent_message_function_scalapack("Trying to find version ${SCALAPACK_FIND_VERSION} on system in CONFIG mode")
...
if (SCALAPACK_FIND_REQUIRED AND NOT SCALAPACK_FOUND)
    message(FATAL_ERROR "OpenCMISS FindModuleWrapper error!\n"
        ...
        "Allow system SCALAPACK: ${OC_SYSTEM_SCALAPACK}\n"
        "Please check your OpenCMISSLocalConfig file and ensure to set USE_SCALAPACK=YES\n"
