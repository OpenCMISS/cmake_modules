...
if (NOT OC_SYSTEM_SUPERLU)
     set(OC_SYSTEM_SUPERLU NO) # set it to NO so that we have a value if none is set at all (debug output)
    ...
    if (SUPERLU_FOUND)
        ...
        my_stupid_package_dependent_message_function_superlu("Found version ${SUPERLU_FIND_VERSION} at ${SUPERLU_DIR} in CONFIG mode")
    endif()
else()
    ...
    if (SUPERLU_FOUND)
        ...
        my_stupid_package_dependent_message_function_superlu("Trying to find version ${SUPERLU_FIND_VERSION} on system in CONFIG mode")
...
if (SUPERLU_FIND_REQUIRED AND NOT SUPERLU_FOUND)
    message(FATAL_ERROR "OpenCMISS FindModuleWrapper error!\n"
        ...
        "Allow system SUPERLU: ${OC_SYSTEM_SUPERLU}\n"
        "Please check your OpenCMISSLocalConfig file and ensure to set USE_SUPERLU=YES\n"
