...
https://github.com/OpenCMISS/manage/issues/28        
    ...
    if(NOT DEFINED OPENCMISS_MPI)
        ...
        if (MPI_FOUND)
			...
			# Make this like the user is suggesting an MPI
			log("Making suggested MPI look like the user specified it")
			set(_USER_SPECIFIED_MPI_FLAG TRUE)
            unset(SUGGESTED_MPI)
        endif()
    endif()
endif()
