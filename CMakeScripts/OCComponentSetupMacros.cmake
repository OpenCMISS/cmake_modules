...
function(addAndConfigureLocalComponent COMPONENT_NAME)
    ...
    if (COMPONENT_NAME IN_LIST "IRON")
        set(BUILD_DIR_BASE "${OPENCMISS_LIBRARIES_BINARY_DIR_MPI}")
        set(_INSTALL_PREFIX ${OPENCMISS_LIBRARIES_INSTALL_PREFIX_MPI})
    elseif (COMPONENT_NAME IN_LIST "ZINC")
        set(BUILD_DIR_BASE "${OPENCMISS_LIBRARIES_BINARY_DIR}")
        set(_INSTALL_PREFIX ${OPENCMISS_LIBRARIES_INSTALL_PREFIX})
...
if (COMPONENT_NAME STREQUAL ZINC)
message(STATUS "-------- Gotta do a zinc.")
endif ()
if (COMPONENT_NAME STREQUAL IRON)
message(STATUS "-------- Gotta do a iron.")
endif ()
